...
const up = async () => {
  try {
    ...
    if (!produto) {
      ...
      produto = await Produto.create({
        ...
        preco: 297.82,
        preco_promocao: 59.99, // 30% de desconto
        label_promocao: true,
        marca: "Nike",
        genero: "masculino",
        numero_vendas: 0,
      ...
      await ProdutoImagem.bulkCreate([
        {
          ...
          url_imagem:
            "https://imgnike-a.akamaihd.net/1920x1920/027285INA8.jpg",
        },
        {
          produto_id: produto.id,
          url_imagem:
            "https://imgnike-a.akamaihd.net/1920x1920/027285INA3.jpg",
        },
    ...
    await ProdutoImagem.bulkCreate([
      {
        produto_id: produto.id,
        url_imagem:
          "https://imgnike-a.akamaihd.net/1920x1920/02990451A2.jpg",
      },
      {
        produto_id: produto.id,
        url_imagem:
          "https://imgnike-a.akamaihd.net/1920x1920/02990451A5.jpg",
      },
    ]);
  ...
  if (!produto) {
    ...
    produto = await Produto.create({
      ...
      preco: 1199.99,
      preco_promocao: 1000.99, // sem desconto
      label_promocao: true,
      marca: "New Balance",
      genero: "masculino",
      numero_vendas: 0,
    ...
    if (!produto) {
      ...
      console.log("Produto 'Tênis Masculino Mizuno Wave Prophecy 12' já existe.");
    }
